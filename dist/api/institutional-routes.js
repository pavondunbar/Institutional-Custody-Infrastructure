...
exports.createInstitutionalRoutes = createInstitutionalRoutes;
...
const approval_service_1 = require("../governance/approval-service");
const aml_service_1 = require("../compliance/aml-service");
const risk_service_1 = require("../risk/risk-service");
const circuit_breaker_1 = require("../risk/circuit-breaker");
const dlq_service_1 = require("../messaging/dlq-service");
const price_oracle_service_1 = require("../oracle/price-oracle-service");
const lending_service_1 = require("../lending/lending-service");
const fx_service_1 = require("../fx/fx-service");
function param(req, name) {
    const val = req.params[name];
    return Array.isArray(val) ? val[0] : val;
}
function createInstitutionalRoutes() {
    const router = (0, express_1.Router)();
    const keyService = new key_service_1.KeyManagementService();
    const settlementService = new settlement_service_1.SettlementService();
    const treasuryService = new treasury_service_1.TreasuryService();
    const monitoringService = new monitoring_service_1.MonitoringService();
    const trustDomainService = new trust_domain_service_1.TrustDomainService();
    const assetLifecycleService = new asset_lifecycle_service_1.AssetLifecycleService();
    const vendorService = new vendor_risk_service_1.VendorRiskService();
    const privacyService = new privacy_service_1.PrivacyService();
    const infraService = new infrastructure_service_1.InfrastructureService();
    const approvalService = new approval_service_1.ApprovalService();
    const amlService = new aml_service_1.AmlService();
    const riskService = new risk_service_1.RiskService();
    const killSwitchService = new circuit_breaker_1.KillSwitchService();
    const dlqService = new dlq_service_1.DLQService();
    const oracleService = new price_oracle_service_1.PriceOracleService();
    const lendingService = new lending_service_1.LendingService();
    ...
    router.post('/keys/:keyId/sign', async (req, res) => {
        try {
    ...
    router.get('/keys/rotation-needed', async (_req, res) => {
        try {
    ...
    router.post('/settlements/netting', async (req, res) => {
        try {
    ...
    router.get('/settlements/pending', async (_req, res) => {
        try {
    ...
    // ======================== TREASURY ========================
    router.post('/treasury/portfolios', async (req, res) => {
        try {
    ...
    router.get('/treasury/portfolios/:id/nav', async (req, res) => {
        try {
    ...
    router.get('/treasury/portfolios/:id/rebalance', async (req, res) => {
        try {
    ...
    router.get('/treasury/portfolios/:id/proof-of-reserves', async (req, res) => {
        try {
    ...
    // ======================== MONITORING & ALERTING ========================
    router.post('/monitoring/rules', async (req, res) => {
        try {
    ...
    router.post('/monitoring/evaluate', async (_req, res) => {
        try {
    ...
    router.get('/monitoring/alerts', async (req, res) => {
        try {
            ...
            const alerts = await monitoringService.getUnresolvedAlerts(severity);
            res.json({ alerts });
        }
        catch (err) {
            res.status(500).json({ error: 'Internal error' });
    ...
    router.get('/monitoring/siem-export', async (req, res) => {
        try {
    ...
    // ======================== TRUST DOMAINS ========================
    router.post('/trust-domains', async (req, res) => {
        try {
    ...
    router.get('/trust-domains', async (_req, res) => {
        try {
    ...
    router.post('/trust-domains/policies', async (req, res) => {
        try {
    ...
    router.post('/trust-domains/authorize', async (req, res) => {
        try {
    ...
    // ======================== ASSET LIFECYCLE ========================
    router.post('/asset-lifecycle/issue', async (req, res) => {
        try {
    ...
    router.post('/asset-lifecycle/burn', async (req, res) => {
        try {
    ...
    router.post('/asset-lifecycle/dividend', async (req, res) => {
        try {
    ...
    router.get('/asset-lifecycle/:assetId/history', async (req, res) => {
        try {
    ...
    router.post('/governance/requests', async (req, res) => {
        try {
    ...
    router.post('/governance/requests/:id/approve', async (req, res) => {
        try {
    ...
    router.post('/governance/requests/:id/reject', async (req, res) => {
        try {
    ...
    router.post('/compliance/travel-rule', async (req, res) => {
        try {
    ...
    router.post('/compliance/sar', async (req, res) => {
        try {
    ...
    router.post('/vendors/:id/assessments', async (req, res) => {
        try {
    ...
    router.post('/vendors/:id/sla-metrics', async (req, res) => {
        try {
    ...
    router.get('/vendors/needs-assessment', async (_req, res) => {
        try {
    ...
    // ======================== PRIVACY ========================
    router.post('/privacy/zk-proof/balance', async (req, res) => {
        try {
    ...
    router.post('/privacy/selective-disclose', async (req, res) => {
        try {
    ...
    router.post('/privacy/data-classification', async (req, res) => {
        try {
    ...
    router.post('/privacy/enforce-retention', async (_req, res) => {
        try {
    ...
    // ======================== INFRASTRUCTURE ========================
    router.post('/infrastructure/nodes', async (req, res) => {
        try {
    ...
    router.get('/infrastructure/nodes/:name/health', async (req, res) => {
        try {
    ...
    router.get('/infrastructure/capacity', async (_req, res) => {
        try {
    ...
    router.post('/infrastructure/failover', async (req, res) => {
        try {
    ...
    router.get('/dlq/stats', async (_req, res) => {
        try {
            res.json(await dlqService.getStats());
        }
        catch (err) {
            res.status(500).json({ error: 'Internal error' });
        }
    ...
    router.get('/dlq/entries', async (req, res) => {
        try {
            const entries = await dlqService.getEntries(req.query.status, req.query.limit ? parseInt(String(req.query.limit)) : undefined);
            res.json({ entries });
        }
        catch (err) {
            res.status(500).json({ error: 'Internal error' });
    ...
    router.post('/dlq/:id/reprocess', async (req, res) => {
        try {
            await dlqService.reprocess(param(req, 'id'));
            res.json({ status: 'reprocessed' });
        }
        catch (err) {
            res.status(400).json({ error: err instanceof Error ? err.message : 'Unknown error' });
        }
    ...
    // ======================== PRICE ORACLE ========================
    router.post('/oracle/quotes', async (req, res) => {
        try {
    ...
    router.get('/oracle/prices/:pair', async (req, res) => {
        try {
    ...
    router.get('/oracle/prices', async (_req, res) => {
        try {
            res.json({ prices: await oracleService.getAllPrices() });
        }
        catch (err) {
            res.status(500).json({ error: 'Internal error' });
        }
    ...
    // ======================== LENDING ========================
    router.post('/lending/loans', async (req, res) => {
        try {
    ...
    router.get('/lending/loans', async (req, res) => {
        try {
            const loans = await lendingService.getActiveLoans(req.query.borrowerId);
    ...
    router.post('/lending/loans/:id/repay', async (req, res) => {
        try {
            await lendingService.repay(param(req, 'id'), BigInt(req.body.amount));
            res.json({ status: 'repaid' });
        }
        catch (err) {
            res.status(400).json({ error: err instanceof Error ? err.message : 'Unknown error' });
        }
    });
    router.post('/lending/monitor', async (req, res) => {
        try {
    ...
    router.post('/lending/loans/:id/liquidate', async (req, res) => {
        try {
    ...
    router.post('/fx/rates', async (req, res) => {
        try {
            await fxService.submitRate(req.body);
            res.status(201).json({ status: 'accepted' });
        }
        catch (err) {
            res.status(400).json({ error: err instanceof Error ? err.message : 'Unknown error' });
    ...
    router.get('/fx/rates/:pair', async (req, res) => {
        try {
    ...
    router.post('/fx/quote', async (req, res) => {
        try {
    ...
    router.post('/fx/conversions/:id/execute', async (req, res) => {
        try {
    ...
    router.get('/fx/pairs', async (_req, res) => {
        try {
            res.json({ pairs: await fxService.getSupportedPairs() });
        }
        catch (err) {
            res.status(500).json({ error: 'Internal error' });
        }
...
//# sourceMappingURL=institutional-routes.js.map